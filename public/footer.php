<footer class="footer-custom px-6">
      <div class="container-fluid">
        <div class="row py-5">
          
          <div class="footer-link col-lg-3 col-sm-6" style="font-size: 0.85rem;">
                <h5 class="pb-3">Go to:</h5>
                ...
                <li>
                  <a href="members.php" class="footer-link">Members Only</a>
                    </li>
                    <li>
                  <a href="account.php" class="footer-link">Account</a>
                    </li>
                </ul>
            </div>
          <div class="col-lg-5 col-sm-6">
                ...
                <li>
                <a href="mailto:B00158733@mytudublin.ie" class="text-dark">
                    B00158733@mytudublin.ie
                </a>
              </li>
                </ul>
            </div>
          ...
          <div class="row">
            <div class="col text-center border-top pt-2">
              <p>&copy;Copyright 2025 - Made by Tony Mahon B00158733</p>
