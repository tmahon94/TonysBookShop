...
<body>
    ...
    /* Adding to cart code */
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                $product_id = 5; /* IMPORTANT THIS MATCHES DATABASE ***** */
    ...
    <div class="container mt-5">
        <h3>Michael Collins</h3>
            <img src="images/michaelcollins.jpg" alt="Michael Collins book" class="img-fluid" style="max-width: 200px;" > </p>
        <p>Biography on Micahel Collins.</p>
        <ul>
            <li>Author: Tim Pat Coogan</li>
            <li>Year published: 2016</li>
            <li>Price: €13.20</li>
        </ul>
<!-- Cart code -->
    <h3>Buy today!</h3>
